...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		INCOMING_CONNECTIONS = INT_FIRST, INCOMING_CONNECTIONS6, OUTGOING_CONNECTIONS, TCP_PORT, UDP_PORT, TLS_PORT,
		...
		AUTO_SEARCH_INTERVAL, MAX_EXTRA_SLOTS,

		INT_LAST };

	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		ADD_FINISHED_INSTANTLY = BOOL_FIRST, ADLS_BREAK_ON_FIRST,
		ALLOW_UNTRUSTED_CLIENTS, ALLOW_UNTRUSTED_HUBS, ALWAYS_CCPM, ALWAYS_TRAY, AUTO_AWAY,
