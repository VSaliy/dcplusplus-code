...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		BOLD_HUB, BOLD_PM, BOLD_SEARCH, SOCKET_IN_BUFFER, SOCKET_OUT_BUFFER, 
		...
		TLS_PORT, FAST_HASH, SORT_FAVUSERS_FIRST, SHOW_SHELL_MENU, SEGMENTED_DL, FOLLOW_LINKS,
		SEND_BLOOM, OWNER_DRAWN_MENUS, CORAL, SEARCH_FILTER_SHARED, MAIN_WINDOW_PANED_POS,
		INT_LAST };
