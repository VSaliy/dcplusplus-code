...
private:
	...
	virtual void on(WindowManagerListener::Window, const string& id) throw();
	virtual void on(WindowManagerListener::Hub, const string& /*name*/, const string& address) throw();
};
