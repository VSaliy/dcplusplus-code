...
public:
	...
	StaticFrame(dwt::TabView* tabView, const tstring& title, unsigned helpId, unsigned iconId, bool manageAccels = true) :
		MDIChildFrame<T>(tabView, title, helpId, iconId, manageAccels)
	{
		tabView->closeActive(this);
